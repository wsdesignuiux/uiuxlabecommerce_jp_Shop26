...
public class SizeAdapter_26 extends RecyclerView.Adapter<SizeAdapter_26.MySizeHolder> {

    private final ArrayList<Size_Model> size_modelArrayList;
    private final Context context;
    private int position;

    public SizeAdapter_26(Context context, ArrayList<Size_Model> size_modelArrayList) {
    ...
    public MySizeHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(context).inflate(R.layout.item_size_26, viewGroup, false);
