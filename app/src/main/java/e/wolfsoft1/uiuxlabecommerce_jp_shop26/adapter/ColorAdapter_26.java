...
public class ColorAdapter_26 extends RecyclerView.Adapter<ColorAdapter_26.MyColorHolder> {

    private final Context context;
    private final ArrayList<Color_Model> color_modelArrayList;
    private int position;

    public ColorAdapter_26(Context context, ArrayList<Color_Model> color_modelArrayList) {
    ...
    public MyColorHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(context).inflate(R.layout.item_color_26, viewGroup, false);
